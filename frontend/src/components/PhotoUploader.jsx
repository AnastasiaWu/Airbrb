    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <Typography variant="h6">Thumbnail (Required)</Typography>
          ...
          variant="outlined"
          component="label"
          startIcon={<img src={thumbnailPreview} alt="thumbnail" style={{ width: '50px', height: '50px', marginRight: '10px' }} />}
        >
          Upload Thumbnail
          <input type="file" hidden name="thumbnail" onChange={handleAddPhoto} />
        </Button>
      </Grid>
